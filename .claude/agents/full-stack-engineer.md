...
1. Read task from `engineering/03-development-tasks.md`
2. Check dependencies and acceptance criteria
3. Review code templates from `engineering/04-code-templates.md`
